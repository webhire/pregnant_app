        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Instrumententafel</span>
            ...
            <li class="navigation-header">
                <span>Apps &amp; Seiten</span>
                <i data-feather="more-horizontal"></i>
            </li>

            <li class="nav-item  ">
                <a href="app/email.html" class="d-flex align-items-center" target="_self">
            ...
            <li class="nav-item  ">
                <a href="app/chat.html" class="d-flex align-items-center" target="_self">
                    <i data-feather="message-square"></i>
                    <span class="menu-title text-truncate">Plaudern</span>
                </a>
            </li>

            <li class="nav-item  ">
                <a href="app/todo.html" class="d-flex align-items-center" target="_self">
                    <i data-feather="check-square"></i>
                    <span class="menu-title text-truncate">Machen</span>
                </a>
            </li>

            <li class="nav-item  ">
                <a href="app/calendar.html" class="d-flex align-items-center" target="_self">
                    <i data-feather="calendar"></i>
                    <span class="menu-title text-truncate">Kalander</span>
                </a>
            </li>

            <li class="nav-item  ">
                <a href="app/kanban.html" class="d-flex align-items-center" target="_self">
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Rechnung</span>
                </a>
                <ul class="menu-content">
                    <li>
                    ...
                    <li>
                        <a href="app/invoice/preview.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Vorschau</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/invoice/edit.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Bearbeiten</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/invoice/add.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Hinzufügen</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  ">
                <a href="app/file-manager.html" class="d-flex align-items-center" target="_self">
                    <i data-feather="save"></i>
                    <span class="menu-title text-truncate">DateimanagerFile ManagerFile Manager</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Rollen &amp; Berechtigungen</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="app/access-roles.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Rollen</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/access-permission.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Genehmigung</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  ">
                ...
                <ul class="menu-content">
                    <li>
                        <a href="app/ecommerce/shop.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Geschäft</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/ecommerce/details.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Einzelheiten</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/ecommerce/wishlist.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Wunschzettel</span>
                        </a>
                    </li>
                    <li>
                        <a href="app/ecommerce/checkout.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Auschecken</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Benutzer</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="app/user/list.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Liste</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Ansehen</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a href="app/user/view/account.html" class="d-flex align-items-center" target="_self">
                                    <span class="menu-item text-truncate">Konto</span>
                                </a>
                            </li>
                            <li>
                                <a href="app/user/view/security.html" class="d-flex align-items-center" target="_self">
                                    <span class="menu-item text-truncate">Sicherheit</span>
                                </a>
                            </li>
                            <li>
                                <a href="app/user/view/billing.html" class="d-flex align-items-center" target="_self">
                                    <span class="menu-item text-truncate">Abrechnungen und Pläne</span>
                                </a>
                            </li>
                            <li>
                                <a href="app/user/view/notifications.html" class="d-flex align-items-center"
                                   target="_self">
                                    <span class="menu-item text-truncate">Benachrichtigungen</span>
                                </a>
                            </li>
                            <li>
                                <a href="app/user/view/connections.html" class="d-flex align-items-center"
                                   target="_self">
                                    <span class="menu-item text-truncate">Anschlüsse</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    <i data-feather="file-text"></i>
                    <span class="menu-title text-truncate">Seiten</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Kontoeinstellungen</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Mail-Vorlage</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a href="../../vuexy-mail-template/mail-welcome.html" class="d-flex align-items-center"
                                   target="_blank">
                                    <span class="menu-item text-truncate">Herzlich willkommen</span>
                                </a>
                            </li>
                            <li>
                                <a href="../../vuexy-mail-template/mail-reset-password.html"
                                   class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Passwort zurücksetzen</span>
                                </a>
                            </li>
                            <li>
                                <a href="../../vuexy-mail-template/mail-verify-email.html"
                                   class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">E-Mail bestätigen</span>
                                </a>
                            </li>
                            <li>
                                <a href="../../vuexy-mail-template/mail-deactivate-account.html"
                                   class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Benutzerkonto deaktivieren</span>
                                </a>
                            </li>
                            <li>
                                <a href="../../vuexy-mail-template/mail-invoice.html" class="d-flex align-items-center"
                                   target="_blank">
                                    <span class="menu-item text-truncate">Rechnung</span>
                                </a>
                            </li>
                            <li>
                                <a href="../../vuexy-mail-template/mail-promotional.html"
                                   class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Werbung</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Authentifizierung</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Anmeldung</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                            ...
                            <li>
                                <a href="auth/login-cover.html" class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Abdeckung</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Registrieren</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                            ...
                            <li>
                                <a href="auth/register-multisteps.html" class="d-flex align-items-center"
                                   target="_blank">
                                    <span class="menu-item text-truncate">Mehrere Schritte</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Passwort vergessen</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Zwei schritte</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a href="auth/two-steps-basic.html" class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Basic</span>
                                </a>
                            </li>
                            <li>
                                <a href="auth/two-steps-cover.html" class="d-flex align-items-center" target="_blank">
                                    <span class="menu-item text-truncate">Abdeckung</span>
                                </a>
                            </li>
                        </ul>
            ...
            <li class="nav-item  ">
                <a href="modal-examples.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Modale Beispiele</span>
                </a>
            </li>
            <li class="navigation-header">
            ...
            <li class="nav-item  ">
                <a href="ui/typography.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Typografie</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="icons/feather.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Feder</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Karte</span>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a href="card/advance.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Voraus</span>
                        </a>
                    </li>
                    <li>
                        <a href="card/statistics.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Statistiken</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="card/actions.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Kartenaktionen</span>
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a href="component/list-group.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Listengruppe</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="component/progress.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Fortschritt</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="component/tabs.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Registerkarten-Komponente</span>
                        </a>
                    </li>
                    <li>
                        <a href="component/timeline.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Zeitleiste</span>
                        </a>
                    </li>
                    <li>
                        <a href="component/toast.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Toast</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Erweiterungen</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="ext-component/sweet-alerts.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Süßer Alarm</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="ext-component/drag-drop.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Ziehen und loslassen</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="ext-component/clipboard.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Zwischenablage</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="ext-component/context-menu.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Kontextmenü</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Seitenlayouts</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="page-layouts/collapsed-menu.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Menü reduzieren</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="page-layouts/without-menu.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Ohne Menü</span>
                        </a>
                    </li>
                    <li>
                        <a href="page-layouts/empty.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Layout leer</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="navigation-header">
                <span>Formulare und Tabellen</span>
                <i data-feather="more-horizontal"></i>
            </li>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a href="form/checkbox.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Kontrollkästchen</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="form/date-time-picker.html" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">Datums- und Uhrzeitauswahl</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item  ">
                <a href="form/layout.html" class="d-flex align-items-center" target="_self">
                    <i data-feather="box"></i>
                    <span class="menu-title text-truncate">Formularlayout</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="form/wizard.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Formzauberer</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="form/validation.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Formularvalidierung</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="table.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Tabelle</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    <i data-feather="grid"></i>
                    <span class="menu-title text-truncate">Datentabelle</span>
                </a>
                <ul class="menu-content">
                    <li>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Diagramme</span>
            ...
            <li class="nav-item  ">
                <a href="maps/leaflet.html" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Faltblattkarten</span>
                </a>
            </li>
            <li class="navigation-header">
                <span>Sonstiges</span>
            ...
            <li class="nav-item  ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Menüebenen</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">zweites Level 2.1</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate">zweites Level 2.2</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                                    <span class="menu-item text-truncate">Drittes Level 3.1</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                                    <span class="menu-item text-truncate">Drittes Level 3.2</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="nav-item disabled ">
                <a href="javascript:void(0)" class="d-flex align-items-center" target="_self">
                    ...
                    <span class="menu-title text-truncate">Deaktiviertes Menü</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="../../vuexy-html-bootstrap-admin-template/documentation-old/documentation-laravel-folder-structure.html"
                   class="d-flex align-items-center" target="_blank">
                    ...
                    <span class="menu-title text-truncate">Dokumentation</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="https://pixinvent.ticksy.com/" class="d-flex align-items-center" target="_blank">
                    ...
                    <span class="menu-title text-truncate">Unterstützung erhöhen</span>
                </a>
            </li>
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="card card-congratulation-medal">
                            <div class="card-body">
                                ...
                                <img src="images/illustration/badge.svg.html" class="congratulation-medal"
                                     alt="Medal Pic"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-statistics">
                            <div class="card-header">
                                @if(Auth::check() && Auth::user()->is_doctor == 1)
                                    <h4 class="card-title">Statistics for admin</h4>
                                @else
                                    <h4 class="card-title">Statistics for user</h4>
                                @endif
                                    <div class="d-flex align-items-center">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/toolbox.svg.html" alt="Toolbar svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/parachute.svg.html"
                                                                 alt="Parachute svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/brush.svg.html" alt="Brush svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/star.svg.html" alt="Star svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/book.svg.html" alt="Book svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/rocket.svg.html" alt="Rocket svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="images/icons/speaker.svg.html" alt="Speaker svg"/>
                                                        </div>
                                                    </div>
                                                    <div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card card-developer-meetup">
                            <div class="meetup-img-wrapper rounded-top text-center">
                                <img src="images/illustration/email.svg.html" alt="Meeting Pic" height="170"/>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    ...
                                    >
                                        <img src="images/portrait/small/avatar-s-9.jpg" alt="Avatar" width="33"
                                             height="33"/>
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                                        ...
                                        class="avatar pull-up"
                                    >
                                        <img src="images/portrait/small/avatar-s-6.jpg" alt="Avatar" width="33"
                                             height="33"/>
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                                        ...
                                        class="avatar pull-up"
                                    >
                                        <img src="images/portrait/small/avatar-s-8.jpg" alt="Avatar" width="33"
                                             height="33"/>
                                    </div>
                                    <div
                                        data-bs-toggle="tooltip"
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img
                                            src="images/icons/google-chrome.png"
                                            class="rounded me-1"
                                            height="30"
                                            alt="Google Chrome"
                                        />
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img
                                            src="images/icons/mozila-firefox.png"
                                            class="rounded me-1"
                                            height="30"
                                            alt="Mozila Firefox"
                                        />
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img
                                            src="images/icons/apple-safari.png"
                                            class="rounded me-1"
                                            height="30"
                                            alt="Apple Safari"
                                        />
                                ...
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="images/icons/opera.png" class="rounded me-1" height="30"
                                             alt="Opera Mini"/>
                        ...
                        <div class="card card-transaction">
                            ...
                            <div class="card-body">
                                ...
                                <div class="transaction-item">
                                    ...
                                    <div class="fw-bolder text-success">{{ $user->email }}</div>
                                </div>
                                @endforeach
                            </div>
                        </div>
